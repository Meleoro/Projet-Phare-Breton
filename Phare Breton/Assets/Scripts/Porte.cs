...
public class Porte : MonoBehaviour
{
    ...
    public void CableThroughDoor(GameObject currentCable, GameObject currentObject, GameObject endOldCable, GameObject startNewCable)
    {
        ...
        newScriptCreator.CreateNodes(currentObject.GetComponentInChildren<SpringJoint>(), currentObject.GetComponent<SpringJoint>(), currentObject.GetComponent<ObjetInteractible>(), null,
